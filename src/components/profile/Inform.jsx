  ...
  return (
    <div className="py-[52px] mobile:py-[40px] flex gap-[40px] mobile:gap-[13px] border-t border-[#9b9b9b] relative">
      ...
      <button
        ...
        className="absolute hover:brightness-90 hover:text-white bg-brand_blue rounded-md right-0 px-[10px] mobile:px-[5px] py-[3px] mobile:py-[5px]"
      >
      ...
      <button
        onClick={onClick}
        className="absolute bg-brand_red hover:brightness-90 hover:text-white rounded-md right-0 bottom-0 px-[10px] py-[3px] mobile:text-[15px]"
      >
        회원탈퇴
      </button>
    </div>
