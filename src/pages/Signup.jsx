...
// import SignUpButton from "@/components/sign/SignButton";
...
//                 />
//                 {inputValues.loginIdError && (
//                   <p className="text-red-500 text-sm -mt-5 ml-2">
//                     {inputValues.loginIdError}
//                   </p>
//                 )}
//                 <InputField
...
//               <SignUpButton text="SIGNUP" type="submit" />
//             </div>
//           </form>
      ...
      <div className="w-[38%] mobile:w-[80%] mobile:max-w-[400px] desktop:max-w-[470px]">
        <div className="flex flex-col items-center desktop:gap-[80px] tablet:gap-[60px] mobile:gap-10">
          ...
          <form onSubmit={onSubmit} className="w-full">
            <div>
              <ul className="flex flex-col gap-[34px] mobile:gap-[13px] text-[14px] mobile:text-[10px]">
                <InputField
                  id="id"
                  placeholder="Id"
                  type="signUp_text"
            ...
            <div className="flex items-center mt-8">
              <label
                htmlFor="experienced"
                className="text-[15px] mobile:text-[12px]"
              >
                경력자이신가요?
              </label>
              {/* <p className="text-[15px] mobile:text-[12px]">경력자이신가요?</p> */}
          ...
          <div className="flex items-center gap-1 justify-center desktop:mt-10">
            <p className="text-[14px] mobile:text-[8px] text-gray_7">
              이미 계정이 있으신가요?
            </p>

            <button
              type="button"
              className="underline font-bold text-[14px] mobile:text-[8px]"
              onClick={() => setShowModal(true)}
            >
              로그인하기
            </button>
