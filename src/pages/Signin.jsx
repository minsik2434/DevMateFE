...
<<<<<<< HEAD:src/pages/Login.jsx
    <div className="laptop:w-[475px] laptop:h-[540px] mobile:w-[300px] mobile:h-[320px] px-[30px] py-[58px] bg-white rounded-xl">
        ...
        <ul className="flex flex-col laptop:gap-[30px] mobile:gap-[14px]">
          <li>
            ...
            <input
              id="id"
              placeholder="Id"
              className="placeholder-[#2f2f2f] laptop:text-[14px] mobile:text-[10px] w-full border-[#d1d1d1] border laptop:px-[20px] laptop:py-[19px] mobile:px-[10px] mobile:py-[8px] rounded-md"
            />
          </li>
          <li>
      ...
      <div className="laptop:mt-[42px] mobile:mt-[14px]">
        <button className="font-bold text-white laptop:text-[14px] mobile:text-[10px] bg-[#828282] w-full laptop:py-[17px] mobile:py-[7px] rounded-[5px]">
          LOGIN
        </button>
      </div>
=======
...
>>>>>>> 5428fa00303f9df19086d6ce39114da81324fc61:src/pages/Signin.jsx
    </div>
  );
}
