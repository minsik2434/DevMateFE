                ...
                <div className='w-[67%] mobile:w-full border-r pt-[46px] pl-[20px] mobile:px-[10px] mobile:pt-[26px] border-[#9b9b9b] mobile:border-none'>
                    ...
                    <div className='border-t border-[#9b9b9b] mt-[7.5%] py-[5%] px-[9%] mobile:px-0 flex flex-col items-center'>
                        ...
                        <div className='laptop:hidden desktop:hidden w-full border flex py-[24px] justify-around items-center border-[#9b9b9b] rounded-lg'> 
                            ...
                            <label htmlFor='comment' className='sr-only'></label>
                            <input id='comment' placeholder='댓글을 작성해보세요' className='w-[60%] px-[10px] py-[3px] placeholder:text-[10px] placeholder:font-bold border border-[#9b9b9b] rounded-lg'/>
                            <button className='px-[5px] py-[4px] border border-black rounded-md'><img src={penImg} className='w-[21px]'></img></button>
                        </div>
                                ...
                                <li>
                                    <div className='w-full border-b border-[#9b9b9b] py-[10px] px-[38px] mobile:px-0'>
                                        <div className='flex items-center'>
                                            ...
                                            <strong className='ml-[14px] desktop:text-[20px] laptop:text-[16px] mobile:text-[14px]'>최민식</strong>
                                            <div className='ml-[45px] text-[10px] mobile:ml-[20px] mobile:text-[8px]'>
                                                <span>10</span>
                                                <span>분전</span>
                                            </div>
                                        </div>
                                        <p className='mt-[16px] mobile:mt-[9px] desktop:text-[14px] laptop:text-[12px] mobile:text-[10px]'>큰일났습니다 도와주세요 어려운 문제가 있습니다 혼나게 생겼습니다</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div className='px-[3%] py-[3%] desktop:w-[33%] laptop:w-[33%] mobile:w-full'>
                    ...
                    <div className='desktop:w-full laptop:w-full desktop:mt-[60px] laptop:mt-[45px]'>
                        <div className='border border-black desktop:px-[25px] desktop:py-[20px] laptop:px-[20px] laptop:py-[15px] mobile:px-[16px] mobile:py-[14px] bg-slate-400 rounded-t-lg'>
                            <h2 className='desktop:text-[20px] laptop:text-[16px] mobile:text-[14px]'>스터디</h2>
                        </div>
                            ...
                            <ul className='flex flex-col gap-[20px] mobile:gap-[10px]'>
                                <li>
                                    <div className='border-b border-[#9b9b9b]'>
                                        <h2 className='desktop:text-[20px] laptop:text-[15px] mobile:text-[15px]'>큰일났습니다</h2>
                                        <div className='flex justify-between py-[9px]'>
                                            <div className='flex'>
                                                <img src={profileImg} className='desktop:w-[25px] laptop:w-[18px] mobile:w-[23px]'/>
                                            ...
                                            <ul className='flex gap-[7px] items-center desktop:text-[12px] laptop:text-[10px] mobile:text-[10px]'>
                                                <li className='flex'>
                                                    <img src={commentImg} className='desktop:w-[12px] laptop:w-[10px] mobile:w-[12px]'/>
                                                    <span>10</span>
                                                </li>
                                                <li className='flex'>
                                                    <img src={viewImg} className='desktop:w-[12px] laptop:w-[10px] mobile:w-[12px]'/>
                                                    <span>10</span>
                                                </li>
                                                <li className='flex'>
                                                    <img src={goodImg} className='desktop:w-[12px] laptop:w-[10px] mobile:w-[12px]'/>
                                                    <span>10</span>
                                                </li>
                                            </ul>
                                        </div>
